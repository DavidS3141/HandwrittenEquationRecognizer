                            ...
                            float value)
{
  ...
  mwSize dimensions [4] = {static_cast<unsigned long>(geom.height), static_cast<unsigned long>(geom.width), static_cast<unsigned long>(geom.depth), static_cast<unsigned long>(geom.size)} ;
